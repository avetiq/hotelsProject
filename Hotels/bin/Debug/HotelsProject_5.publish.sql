...
AS
	...
	INSERT INTO HotelsRoomsInfo([HotelId],[BedQuantity],[RoomQauntity],[Money])
				Values (@HotelIdd, @BedQuantity, @RoomQauntity, @Money);
GO
...
AS
	...
	EXEC ForAddingHotels @Hotelidd = @GetHotelid, @RoomQauntity = @RoomQauntity1, @BedQuantity = @BedQuantity1, @Money = @Money1;
	EXEC ForAddingHotels @Hotelidd = @GetHotelid, @RoomQauntity = @RoomQauntity2, @BedQuantity = @BedQuantity2, @Money = @Money2;
	EXEC ForAddingHotels @Hotelidd = @GetHotelid, @RoomQauntity = @RoomQauntity3, @BedQuantity = @BedQuantity3, @Money = @Money3;
GO
