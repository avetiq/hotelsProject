...
ALTER TABLE [dbo].[booked]
    ADD CONSTRAINT [Booked_to_Hotels_ref] FOREIGN KEY ([Hotelid]) REFERENCES [dbo].[Hotels] ([ID]);
...
Declare @MarriotID int 

execute @MarriotID = ReturningHotelid @HotelName = 'Marriott', @CityName = 'Yerevan'; 

EXEC ForAddingHotels @Hotelid = @MarriotID, @RoomQauntity = 10, @BedQuantity = 1, @Money = 17000;
EXEC ForAddingHotels @Hotelid = @MarriotID, @RoomQauntity = 10, @BedQuantity = 2, @Money = 28000;
EXEC ForAddingHotels @Hotelid = @MarriotID, @RoomQauntity = 10, @BedQuantity = 3, @Money = 37000;
GO
